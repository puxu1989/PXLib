   ...
   public class IPHelper
    {
        ...
        #endregion
       /// <summary>
        /// 获取本机InterNetwork的IP地址 简单粗暴
       /// </summary>
       /// <returns></returns>
       public static string GetLocalIPAddress()
       {
           return Dns.GetHostEntry(Dns.GetHostName()).AddressList.FirstOrDefault<IPAddress>(a => a.AddressFamily == AddressFamily.InterNetwork).ToString();
       }
       /// <summary>    
       /// 获取客户端的IP    
       /// </summary>    
