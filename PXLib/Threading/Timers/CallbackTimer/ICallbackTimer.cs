...
namespace PXLib.Threading.Timers.CallbackTimer
{
    ...
    public interface ICallbackTimer<T> : ICycleEngine
    {
        ...
        int AddCallback(int spanInSecs, Action<T> _callback, T _callbackPara);
        ...
        /// </summary>
        int RemoveCallbackAndAddNew(int taskIDToRemoved, int spanInSecs, Action<T> _newCallback, T _newCallbackPara);
