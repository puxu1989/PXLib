...
namespace PXLib.Caches
{
    ...
    public interface ICache
    {
        ...
        void WriteCache<T>(string cacheKey,T value,DateTime absoluteExpiration) where T : class;
        /// <summary>
        /// 写入缓存 最后一次访问后多久过期 相对时间
        /// </summary>
        void WriteCache<T>( string cacheKey, T value,TimeSpan slidingExpiration) where T : class;
        /// <summary>
        /// 移除指定数据缓存
        /// </summary>
        /// <param name="cacheKey">键</param>
