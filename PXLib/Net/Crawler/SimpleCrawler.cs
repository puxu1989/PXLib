...
namespace PXLib.Net.Crawler
{
    //简单网络爬虫程序
    /*调用示例
     *  SimpleCrawler sc = new SimpleCrawler();
             sc.OnStart += OnStart;或者 sc.OnCompleted += (s, e) =>{
     * 重点处理正则表达式
    ...
    public class SimpleCrawler
    {
        ...
        /// <summary>
        /// 同步创建爬虫  (原版是异步创建 需要.NET4.5 关键字await ,async,Task<T>)
        /// </summary>
        /// <param name="uri">爬虫URL地址</param>
        /// <param name="proxy">代理服务器</param>
        /// <returns>网页源代码</returns>
        public void Start(Uri uri, string proxy = null)
        {
